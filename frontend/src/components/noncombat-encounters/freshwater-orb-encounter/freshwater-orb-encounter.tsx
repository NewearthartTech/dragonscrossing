...
import styles from "./freshwater-orb-encounter.module.scss";
...
const FreshwaterOrbEncounterComponent: React.FC<Props> = (props: Props) => {
  ...
  return (
    <Grid container direction="row" className={styles.main}>
      <Grid container className={styles.container}>
        ...
        <Grid container className={styles.orbImageContainer}>
          <Grid container className={styles.orbBackgroundImage}>
            <Image
          ...
          <Grid container className={styles.orbImage}>
            <Image
              src="/img/miscellaneous/freshwater-orb.jpg"
...
export default FreshwaterOrbEncounterComponent;
