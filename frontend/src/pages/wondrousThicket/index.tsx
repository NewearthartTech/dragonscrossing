...
import styles from "./wondrousThicket.module.scss";
...
const WondrousThicket: NextPage<Props> = (props: Props) => {
  ...
  return (
    <Grid container direction="column" className={styles.main}>
      ...
      <Grid container direction="row" className={styles.container}>
        ...
        <DCXTile tileName={DcxTiles.FeyClearing} />
...
export default withHoc(WondrousThicket);
