...
import styles from "./blacksmith.module.scss";
...
const BlackSmith: NextPage<Props> = (props: Props) => {
  return (
    <Grid container direction="column" className={styles.main}>
      <Image src="/img/backgrounds/blacksmith-interior.jpg" layout="fill" quality={100} />
      <Grid container className={styles.opaqueContainer} />
      <Grid container direction="row" className={styles.container}>
        <Vendor vendorType={VendorType.BLACKSMITH} />
      </Grid>
    </Grid>
  );
};

export default withHoc(BlackSmith);
