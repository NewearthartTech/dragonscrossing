...
import styles from "./adventuringGuild-foul-wastes.module.scss";
...
const AdventuringGuildFoulWastes: NextPage<Props> = (props: Props) => {
  return (
...
export default withHoc(AdventuringGuildFoulWastes);
