...
public class DoCombat
{
    ...
    private bool DoesHeroGoFirst()
    {
        ...
        var randomNumHero = random.Next(1, 20) + heroCombatStatsCalculated.GetMaxQuickness();
        var randomNumMonster = random.Next(1, 20) + combat.Monster.Quickness;
