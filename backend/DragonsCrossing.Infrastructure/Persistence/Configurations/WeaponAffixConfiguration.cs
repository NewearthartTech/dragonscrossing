...
{
    internal class WeaponAffixConfiguration : IEntityTypeConfiguration<WeaponAffix>
    {
        public void Configure(EntityTypeBuilder<WeaponAffix> builder)
        {
            builder.ToTable(nameof(WeaponAffix));
