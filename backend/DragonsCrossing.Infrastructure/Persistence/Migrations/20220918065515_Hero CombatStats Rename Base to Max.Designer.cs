...
namespace DragonsCrossing.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220918065515_Hero CombatStats Rename Base to Max")]
    partial class HeroCombatStatsRenameBasetoMax
    {
            ...
            modelBuilder.Entity("DragonsCrossing.Domain.Heroes.HeroTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2022, 9, 18, 0, 55, 14, 656, DateTimeKind.Local).AddTicks(3349),
            ...
            modelBuilder.Entity("DragonsCrossing.Domain.Players.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2022, 9, 18, 0, 55, 14, 656, DateTimeKind.Local).AddTicks(3551),
                            GameSettingId = 1,
                            Name = "Test Player 1",
