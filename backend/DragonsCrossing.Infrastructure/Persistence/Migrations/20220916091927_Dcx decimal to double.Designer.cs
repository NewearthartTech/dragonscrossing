...
namespace DragonsCrossing.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20220916091927_Dcx decimal to double")]
    partial class Dcxdecimaltodouble
    {
            ...
            modelBuilder.Entity("DragonsCrossing.Domain.Heroes.HeroTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2022, 9, 16, 3, 19, 26, 567, DateTimeKind.Local).AddTicks(6971),
            ...
            modelBuilder.Entity("DragonsCrossing.Domain.Players.Player", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DateCreated = new DateTime(2022, 9, 16, 3, 19, 26, 567, DateTimeKind.Local).AddTicks(7183),
                            GameSettingId = 1,
                            Name = "Test Player 1",
